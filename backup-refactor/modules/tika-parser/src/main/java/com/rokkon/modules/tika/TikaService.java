...
/**
 * Tika gRPC service implementation using Quarkus reactive patterns with Mutiny.
    ...
    public Uni<ServiceRegistrationData> getServiceRegistration(Empty request) {
        return Uni.createFrom().item(() -> {
            try {
                ...
                // Return minimal registration on error
