...
MODULE_NAME=${MODULE_NAME:-embedder}
...
# Start the module in the background (unified server uses single port)
echo "Starting embedder module on port ${MODULE_PORT}..."
...
# Give the module more time to start up (embedder loads ML models)
echo "Waiting for embedder module to load ML models..."
sleep 20
