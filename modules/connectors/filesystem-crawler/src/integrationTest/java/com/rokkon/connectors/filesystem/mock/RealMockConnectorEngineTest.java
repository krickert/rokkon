...
/**
 * Simple test for the RealMockConnectorEngine.
 * This test verifies that the RealMockConnectorEngine is working correctly.
 */
@QuarkusTest
public class RealMockConnectorEngineTest {

    @Inject
    ConnectorEngine connectorEngine;

    @Inject
    RealMockConnectorEngineProducer mockEngineProducer;

    @Test
    void testRealMockConnectorEngine() throws InterruptedException {
        // Verify that the injected ConnectorEngine is our RealMockConnectorEngine
        assertTrue(connectorEngine instanceof RealMockConnectorEngine, 
                "Injected ConnectorEngine should be a RealMockConnectorEngine");

        // Get the mock engine from the producer
        RealMockConnectorEngine mockEngine = mockEngineProducer.getMockEngine();
