...
/**
 * Simple test to verify that the MockConnectorEngine can be injected and used.
 */
@QuarkusTest
public class SimpleMockEngineTest {
    ...
    void testMockConnectorEngine() throws InterruptedException {
        ...
        ConnectorRequest request = ConnectorRequest.newBuilder()
                ...
                // .setConnectorId("test-1") // Commented out due to classpath issues
