...
/**
 * Simple test that uses the RealMockConnectorEngine directly without relying on CDI.
 */
public class DirectRealMockEngineTest {

    @Test
    void testDirectRealMockEngine() throws InterruptedException {
