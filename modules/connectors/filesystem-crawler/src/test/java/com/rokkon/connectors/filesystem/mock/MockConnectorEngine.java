...
/**
 * A mock implementation of the ConnectorEngine interface for testing.
 * This class can be used in both unit and integration tests to simulate
 * the behavior of the real ConnectorEngine.
 */
public class MockConnectorEngine implements ConnectorEngine {
    private static final Logger LOG = Logger.getLogger(MockConnectorEngine.class);
    ...
    /**
     * Create a new MockConnectorEngine with default behavior.
     */
    public MockConnectorEngine() {
        this(0);
    }

    /**
     * Create a new MockConnectorEngine with a latch for the expected number of documents.
     *
     * @param expectedDocuments The number of documents expected to be processed
     */
    public MockConnectorEngine(int expectedDocuments) {
    ...
    public Uni<ConnectorResponse> processConnectorDoc(ConnectorRequest request) {
        LOG.debug("MockConnectorEngine received request: " + request.getDocument().getSourceUri());
    ...
    private ConnectorResponse defaultResponseFunction(ConnectorRequest request) {
        return ConnectorResponse.newBuilder()
                ...
                .setAccepted(true)
                .setMessage("Document accepted by MockConnectorEngine")
                .build();
    }
}
