...
/**
 * Unit test using the real test-module Docker container.
 * This replaces DummyProcessorUnitTest with the actual test-module.
 */
@QuarkusTest
@Testcontainers
public class TestModuleProcessorUnitTest extends TestModuleProcessorTestBase {
