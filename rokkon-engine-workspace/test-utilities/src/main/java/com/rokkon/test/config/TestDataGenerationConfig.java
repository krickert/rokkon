...
public class TestDataGenerationConfig {
    ...
    /**
     * System property to enable saving output bin documents.
     * Set -Drokkon.test.data.save.output.bin=true to enable.
     */
    public static final String SAVE_OUTPUT_BIN_PROPERTY = "rokkon.test.data.save.output.bin";
     ...
     */
    public static boolean isSaveOutputBinEnabled() {
        return Boolean.parseBoolean(System.getProperty(SAVE_OUTPUT_BIN_PROPERTY, "false"));
    }
}
