...
grpcurl -plaintext localhost:49093 grpc.health.v1.Health/Check

echo -e "\n\nTesting service registration..."
grpcurl -plaintext localhost:49093 com.rokkon.search.model.PipeStepProcessor/GetServiceRegistration
...
}' localhost:49093 com.rokkon.search.model.PipeStepProcessor/ProcessData
