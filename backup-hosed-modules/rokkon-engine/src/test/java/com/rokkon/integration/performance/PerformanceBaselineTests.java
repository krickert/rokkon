...
@Disabled("Requires full gRPC service infrastructure for performance baseline testing and throughput measurements")
class PerformanceBaselineTests {
    ...
    void testEndToEndPipelinePerformance() throws Exception {
