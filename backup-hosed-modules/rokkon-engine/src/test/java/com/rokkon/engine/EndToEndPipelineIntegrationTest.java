...
import com.rokkon.search.registration.api.HealthCheckType;
import com.rokkon.search.registration.api.ModuleRegistrationServiceGrpc;
import com.rokkon.search.registration.api.RegisterModuleRequest;
import com.rokkon.search.registration.api.RegisterModuleResponse;
 ...
 */
@Disabled("Requires API updates for gRPC registration interfaces and service names")
...
class EndToEndPipelineIntegrationTest {
    ...
    void testServiceDiscovery() {
        ...
        RegisterModuleResponse tikaResponse = tikaRegistrationClient.registerModule(RegisterModuleRequest.newBuilder()
                .setHost("localhost")
                .setPort(9000)
                        .setInstanceServiceName("tika-parser")
        ...
        // assertEquals("tika-parser", tikaResponse.getServiceName()); // TODO: API update needed
        
        // Test Chunker registration
        // RegisterModuleResponse chunkerResponse = chunkerRegistrationClient.registerModule(Empty.getDefaultInstance()); // TODO: API update needed
        ...
        // RegisterModuleResponse embedderResponse = embedderRegistrationClient.registerModule(Empty.getDefaultInstance()); // TODO: API update needed
        ...
        // RegisterModuleResponse echoResponse = echoRegistrationClient.registerModule(Empty.getDefaultInstance()); // TODO: API update needed
