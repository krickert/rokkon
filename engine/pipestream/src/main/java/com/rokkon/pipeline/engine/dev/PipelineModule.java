...
public enum PipelineModule {
    ECHO("echo", "rokkon/echo-module:latest", "Simple echo module for testing", "1G"),
    TEST("test", "rokkon/test-module:latest", "Test module for pipeline validation", "1G"),
    PARSER("parser", "rokkon/parser-module:latest", "Document parser module", "1G"),
