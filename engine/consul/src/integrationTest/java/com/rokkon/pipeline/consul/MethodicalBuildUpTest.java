 ...
 * Runs with real Consul and test-module containers.
 * This test is disabled by default and should be run as part of the integration test suite.
 */
@Disabled("Integration test - requires full container setup. Run as part of integration test suite.")
@QuarkusTest
