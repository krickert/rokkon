...
/**
 * Integration test version of MethodicalBuildUpTest.
 * This test uses real Consul and other services via Testcontainers.
 */
@QuarkusIntegrationTest
@QuarkusTestResource(ConsulTestResource.class) // Assuming ConsulTestResource manages Testcontainers Consul
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class MethodicalBuildUpIntegrationTest extends MethodicalBuildUpTestBase {
    private static final Logger LOG = Logger.getLogger(MethodicalBuildUpIntegrationTest.class);
    ...
    @Inject
    TestSeedingService testSeedingService; // Inject the real service
    ...
    // ConsulTestResource will manage the Consul Testcontainer lifecycle
    // No need for @Container here, as it's handled by the resource
}
