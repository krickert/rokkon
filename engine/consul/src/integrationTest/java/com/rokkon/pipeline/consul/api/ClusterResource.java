...
/**
 * Integration test implementation of ClusterResource for the consul module.
 * This class is used for testing the ClusterService via REST API in integration tests.
 */
