...
public class PipelineDefinitionResource {
     ...
     */
    @Schema(description = "Pipeline definition summary")
    public record PipelineDefinitionSummary(
        @Schema(description = "Pipeline ID", example = "document-processing")
        String id,
        
        @Schema(description = "Pipeline name", example = "Document Processing Pipeline")
        String name,
        
        @Schema(description = "Description", example = "Processes documents through parsing, chunking, and embedding")
        String description,
        
        @Schema(description = "Number of steps in the pipeline", example = "3")
        int stepCount,
        
        @Schema(description = "Creation timestamp", example = "2024-01-15T10:30:00Z")
        String createdAt,
        
        @Schema(description = "Last modified timestamp", example = "2024-01-15T14:45:00Z")
        String modifiedAt,
        
        @Schema(description = "Number of active instances", example = "2")
        int activeInstances
    ) {}
