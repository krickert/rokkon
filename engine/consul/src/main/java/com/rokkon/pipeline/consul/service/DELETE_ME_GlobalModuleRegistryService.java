...
public class DELETE_ME_GlobalModuleRegistryService implements com.rokkon.pipeline.commons.model.GlobalModuleRegistryService {
    ...
    public record ModuleRegistration(
        ...
        public boolean equals(Object o) {
            ...
            // Two registrations are equal if they have the same moduleId
     ...
     */
    public record ZombieCleanupResult(
        int zombiesDetected,
        int zombiesCleaned,
        List<String> errors
    ) {}
            ...
            if (checks != null) {
                for (var check : checks) {
                    ...
                    if (status == CheckStatus.CRITICAL) {
                        worstStatus = CheckStatus.CRITICAL;
                        break;
                    } else if (status == CheckStatus.WARNING && worstStatus == CheckStatus.PASSING) {
