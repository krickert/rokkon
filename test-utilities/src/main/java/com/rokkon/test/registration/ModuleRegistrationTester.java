...
public class ModuleRegistrationTester {
     ...
     */
    public void verifyModuleRegistration(Uni<ServiceRegistrationData> registrationUni, String expectedModuleName, String... expectedConfigKeys) {
     ...
     */
    public void verifyEchoServiceRegistration(Uni<ServiceRegistrationData> registrationUni) {
     ...
     */
    public void verifyTikaServiceRegistration(Uni<ServiceRegistrationData> registrationUni) {
     ...
     */
    public void verifyChunkerServiceRegistration(Uni<ServiceRegistrationData> registrationUni) {
     ...
     */
    public void verifyEmbedderServiceRegistration(Uni<ServiceRegistrationData> registrationUni) {
     ...
     */
    public void verifyNullInputHandling(Uni<ServiceRegistrationData> registrationUni) {
     ...
     */
    public void performComprehensiveRegistrationTest(Uni<ServiceRegistrationData> registrationUni, String moduleName, String... configKeys) {
